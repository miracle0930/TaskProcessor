...
/**
 * Created by guanhao on 2018/2/8.
 */

public class SwipeListViewOnTouchListener implements View.OnTouchListener {
    private int mSlop;
    ...
    /**
     * The callback interface used by {@link SwipeListViewOnTouchListener} to inform its client
     ...
     */
    public SwipeListViewOnTouchListener(ListView listView, OnSwipeCallback callback) {
     ...
     * @see #SwipeListViewOnTouchListener(ListView, OnSwipeCallback, boolean, boolean)
     */
    public SwipeListViewOnTouchListener(ListView listView, OnSwipeCallback callback, boolean dismissLeft, boolean dismissRight) {
     ...
     * {@link SwipeListViewOnTouchListener} is paused during list view scrolling.</p>
     *
     * @see {@link SwipeListViewOnTouchListener}
     */
